...
async function loadCovenantData(): Promise<CovenantData> {
...
async function integrateCovenantData(data: CovenantData) {
...
export { loadCovenantData, integrateCovenantData };
